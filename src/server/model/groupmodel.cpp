...
// Show User's Group 返回所有用户的群组信息的vector
vector<Group> GroupModel::queryGroups(int userid){
    /*
      联合查询 AllGroup与GroupUser表，当id = id时输出  
      查询groupid groupname groupdesc 和组内的所有成员
    */
    char sql[1024] = {0};
...
// 根据指定groupid查询群组用户id列表， 群消息通过一个人发给群内其他成员群发消息
